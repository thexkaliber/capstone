...
from astroclip.models.vim.ssl_meta_arch import SSLMetaArch
...
from astroclip.models.vim import *
...
def do_train(cfg, model, run_name, group_name, resume=False):
    ...
    # checkpointer - replace FSDPCheckpointer with Checkpointer
